...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (hud == nil)
	{
        ...
        // border radius
        [hud.layer setCornerRadius:5.0f];
        [hud.layer setShadowColor:[UIColor blackColor].CGColor];
        [hud.layer setShadowOpacity:0.1];
        [hud.layer setShadowRadius:3.0];
        [hud.layer setShadowOffset:CGSizeMake(2.0, 2.0)];
        
        [ViewUtilities roundingUIView:hud cornerRadius:5.0f];
