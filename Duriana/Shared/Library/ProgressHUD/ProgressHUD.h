...
//-------------------------------------------------------------------------------------------------------------------------------------------------
#define HUD_STATUS_FONT			[UIFont boldSystemFontOfSize:16.0f]
#define HUD_STATUS_COLOR		[UIColor colorWithHexString:@"434C55"]

#define HUD_SPINNER_COLOR		[UIColor colorWithHexString:@"434C55"]
#define HUD_BACKGROUND_COLOR	[UIColor whiteColor]
